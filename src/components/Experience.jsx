...
const Details = ({ position, company, address, duration, work, isLightMode }) => {
...
export default function Experience({ isLightMode }) {
    ...
    return (
        <div className='mb-36 mt-10'>
            <h2 className='font-bold text-5xl mb-20 w-full text-center md:text-3xl max-[640px]:text-2xl'>Experience</h2>
